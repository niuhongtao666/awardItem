...
//		var avatar = new Image();
		...
		back_img.src = './img/award_0'+ '.' + pic_format;
...
//		context.drawImage(back_img, 0, 0);
			...
			context.font = "bold 90px STKaiti";
			//          if (name_zh.length <= 2) {
...
//                  this.music.pause();
        ...
        if (award_history == 4) {
            $('#award-04').show();
            $('#award-04 .award-title').show();
            $('#award-123').show();
        }else if(award_history == 1||award_history == 2||award_history == 3){
            $('#award-123').show();
            var award4_storage = window.localStorage.getItem('award_4');
            if(!award4_storage){
                $('#award-04 .award-title').hide();
